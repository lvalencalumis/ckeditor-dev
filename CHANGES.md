...
* [#1115](https://github.com/ckeditor/ckeditor-dev/issues/1115): Fixed: Cannot keep `<font>` tag, when proper config for [Font Size and Family](https://ckeditor.com/cke4/addon/font) plugin is provided.
